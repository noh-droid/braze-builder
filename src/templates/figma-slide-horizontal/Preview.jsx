...
const PLACEHOLDER = "https://placehold.co/270x180/e2e8f0/94a3b8?text=Slide";

export default function FigmaSlideHorizontalPreview({ config }) {
  const cw = config.cardWidth ?? 310;
  const sw = config.slideImageWidth ?? 270;
  const sh = config.slideImageHeight ?? 180;
