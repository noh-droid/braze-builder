      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={modalPreviewBottomFootLeftStyle(config.bottomColor, `${config.btnFont}, sans-serif`)}>{config.bottomLeftText}</span>
            <span style={modalPreviewBottomFootRightStyle(config.bottomColor, `${config.btnFont}, sans-serif`)}>
