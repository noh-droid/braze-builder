      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={modalPreviewBottomFootLeftStyle(config.bottomColor, `${config.titleFont}, sans-serif`)}>{config.bottomLeftText}</span>
            <span style={modalPreviewBottomFootRightStyle(config.bottomColor, `${config.titleFont}, sans-serif`)}>
